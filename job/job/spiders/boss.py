...
,'软件工程师','it项目经理','安全运维工程师','游戏开发工程师','UI设计','区块链开发工程师','C语言开发工程师','游戏界面设计师','IOS开发工程师','Android开发工程师']
    ...
    def start_requests(self):
        yield scrapy.Request(
            self.url.format(pageNo=self.now_page, keyword=self.keyword_list[self.now_keyword_index], city=100010000),
            callback=self.parse,
    ...
    def parse(self, response):
        ...
        try:
            ...
            next_url = self.url.format(pageNo=self.now_page, city=100010000,
            ...
            if self.now_page == 11:
                ...
                if not self.now_keyword_index == len(self.keyword_list) - 1:
                    ...
                    self.now_page = 1
                    yield scrapy.Request(
                        self.url.format(pageNo=self.now_page, city=100010000,
                                        keyword=self.keyword_list[self.now_keyword_index]))
                else:
                    return
            else:
